...
cd /home/ubuntu/Todo-App || { echo "Failed to change directory" >> /home/ubuntu/clean_instance.log; exit 1; }
echo "Changed directory to /home/ubuntu/Todo-App" >> /home/ubuntu/clean_instance.log
